...
> **Поправка независимой проверки 23.09.2026:** это исторический исследовательский материал,
> не свод законов. Критические выводы ниже проверены и частично опровергнуты:
> деление числа ног на ширину не доказывает плато максимальной высоты или границу 3–5;
> `MAX` отдельных подъёмов не описывает мостик натянутой нити; 0,28 мм и `m^0,85`
> зависят от неподтверждённых материальных параметров. «Прямо между удержаниями» требует
> оговорок о распределённом контакте и трении. Обновлены текущие `docs/assumptions.md`,
> `docs/thread-over-thread.md`, `spec/pile-render.md`, HANDOFF и публичная документация.
> Остальные 35 пунктов не получают автоматического подтверждения от этой проверки.
> Основания и пределы: [итоговый отчёт](2026-09-23-integration-validation.md).
